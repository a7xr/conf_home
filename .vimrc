...
" to enable #fold													%034
" there is no < and > then I created a map for them					%035
" when u create a #cFile, then it will create a #template			%036
" 	#automatically	
" when u create a #cppFile, then it will create a #template			%037
" 	#automatically	
...
"	%037
autocmd BufNewFile *.cpp 0r /root/.vim/nonicken/templates/cpp.tpl

"	%036
autocmd BufNewFile *.c 0r /root/.vim/nonicken/templates/c.tpl
